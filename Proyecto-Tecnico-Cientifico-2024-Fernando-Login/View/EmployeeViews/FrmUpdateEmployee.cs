...
namespace PTC2024.View.Empleados
{
    public partial class FrmUpdateEmployee : Form
    {
        ...
        {
            InitializeComponent();
            ControllerUpdateEmployee objControl = new ControllerUpdateEmployee(this, employeeId, names, lastNames, dui, birthDate, email, phone, address, salary, bankAccount, bank, affiliationNumber, hireDate, department, employeeType, maritalStatus, status, username, businessP, idBank, idDepartment, idTypeE, idMaritalS, idStatus, idBusinessP);
