...
{
    public partial class FrmBusinessConfiguration : Form
    {
        public FrmBusinessConfiguration()
        {
            InitializeComponent();
            ControllerBusinessConfiguration objController = new ControllerBusinessConfiguration(this);
        }
